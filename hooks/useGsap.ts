...
type GsapSetup = (gsap: typeof import("gsap").default, scope: HTMLElement) => (() => void) | void;
...
export function useGsap(setup: GsapSetup, deps: React.DependencyList = []) {
  ...
  useEffect(() => {
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: consumer-provided deps
  }, [reduced, ...deps]);
