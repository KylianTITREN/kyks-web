...
export function Hero() {
  ...
  const ref = useGsap((gsap, scope) => {
    ...
    gsap.set(visual, { opacity: 0, scale: 0.96, willChange: "opacity, transform" });
    ...
    tl.to(lines, { yPercent: 0, duration: 1.1, stagger: 0.08 })
      ...
      .to(visual, { opacity: 0.07, scale: 1, duration: 1.2, ease: "power2.out", clearProps: "willChange" }, "-=1.2");
