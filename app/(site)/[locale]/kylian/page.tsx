...
import type { Education, Experience, Project, SkillGroup, SocialLink } from "@/sanity/types";
...
export default async function KylianPage({ params }: { params: Promise<{ locale: Locale }> }) {
	const { locale } = await params;
