...
const collaborations = [
	{
		...
		role: {
			fr: "Mission tech — frontend & BFF",
			en: "Tech engagement — frontend & BFF",
		},
		summary: {
	...
	},
	{
		...
		role: {
			fr: "Mission tech — mobile & plateforme",
			en: "Tech engagement — mobile & platform",
		},
		summary: {
...
const projects = [
	...
	},
	{
		...
		highlights: {
			...
			en: [
				"Full checkout flow",
				"Strapi headless CMS for self-service management",
	...
	},
	{
		...
		highlights: {
			...
			en: [
				"Accessible and shareable product catalog",
				"Lead generation via contact form",
				"Optimized for live booth sharing",
			],
		},
...
async function seed() {
	...
	try {
		...
		console.log(
			`✓ Transaction commitée — ${result.documentIds?.length ?? allDocs.length} docs upsertés.`,
		);
	} catch (err) {
